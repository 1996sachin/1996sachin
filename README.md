...
Recently, I’ve been working as a **Junior DevOps Engineer** deploying projects with **Docker, Jenkins, and GitHub Webhooks** (Node.js, Python, Django Framework, PHP Laravel Framework) and configuring an **Asterisk Server** on Ubuntu for local calling.  
